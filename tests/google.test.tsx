...
describe('Google Calendar API Functions', () => {
  ...
  //     // Verify timeMin is expected date in ISO format
  //     const expectedDate = new Date('2025-04-24T12:00:00Z'); // One month ahead of mock date
  //     expect(callParams.timeMin).toBe(expectedDate.toISOString());

  //     // Verify timeMax is approximately one month later than timeMin
